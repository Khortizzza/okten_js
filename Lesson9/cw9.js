...
//     elementDiv.innerText = `${simpson.name} ${simpson.surname} ${simpson.age} ${simpson.info}`
...
//     elemName.innerText = simpson.name;
//     elementDiv.appendChild(elemName);
//
//
//     let elemSurname = document.createElement('div');
//     elemSurname.innerText = simpson.surname;
//     elementDiv.appendChild(elemSurname);
//
//     let elemAge = document.createElement('div');
//     elemAge.innerText = simpson.age;
//     elementDiv.appendChild(elemAge);
//
//     let elemInfo = document.createElement('div');
//     elemInfo.innerText = simpson.info;
//     elementDiv.appendChild(elemInfo);
//
//     let elemImg = document.createElement('img');
//     elemImg.src = simpson.photo
//     elementDiv.appendChild(elemImg);
//
//     document.body.appendChild(elementDiv);
// }
